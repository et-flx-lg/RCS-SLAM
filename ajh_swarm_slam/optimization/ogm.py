...
class Map():
    ...
    def update_map(self, pose, z, bumps):
        ...
        for b_i in bumps:
            ...
            b = b_i[1] + map.theta + np.pi/2 # bearing measured
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(state.T))):
        ...
        map.update_map(state[:,i], meas[:,:,i], bumps[:, :, i]) # update the map
        ...
        arrow = (pose[0:2] / map.grid_size + np.array([0.3/map.grid_size, 0]).dot(
